...
class ManageUsersController extends Controller {
    ...
    public function detail($id) {
        ...
        $totalWithdrawal = Withdrawal::approved()->where('user_id', $user->id)->sum('amount');
        $totalTransaction = Transaction::where('user_id', $user->id)->count();

        $pendingDeposits = Deposit::where('user_id', $user->id)->pending()->count();
        $pendingWithdrawals = Withdrawal::where('user_id', $user->id)->pending()->count();

        $pendingTickets = SupportTicket::where('user_id', $user->id)->pending()->count();

        $countries = json_decode(file_get_contents(resource_path('views/partials/country.json')));
        return view('admin.users.detail', compact('pageTitle', 'user', 'totalDeposit', 'totalTransaction', 'totalWithdrawal', 'countries', 'pendingDeposits', 'pendingWithdrawals', 'pendingTickets'));
    }
