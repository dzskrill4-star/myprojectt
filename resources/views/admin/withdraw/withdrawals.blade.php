                                ...
                                @forelse($withdrawals as $withdraw)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <span class="small"> <a href="{{route('admin.users.detail', $withdraw->user->id)}}"><span>@</span>{{ $withdraw->user->username }}</a>
                                            </span>
                                        </td>
...
@push('breadcrumb-plugins')
    <x-search-form dateSearch='yes' placeholder='Username / TRX No.' />
@endpush
