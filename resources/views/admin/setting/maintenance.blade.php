                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-4">
                        <div class="form-group">
                            ...
                            <x-image-uploader class="w-100" :imagePath="getImage(getFilePath('maintenance') . '/' . ($maintenance->data_values?->image??null), getFileSize('maintenance'))" :size="getFileSize('maintenance')" :required="false" name="image" />
