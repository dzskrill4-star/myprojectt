...
class BadgeController extends Controller {
    public function index() {
        $pageTitle = "Badge";
        $badges =  Badge::orderBy('earning_amount')->paginate(getPaginate());
    ...
    private function validateRequest($request, $id = 0) {
        $request->validate([
            ...
            'earning_amount'            => 'required|numeric|gte:0',
            'discount_maintenance_cost' => 'required|numeric|gte:0',
            'plan_price_discount'       => 'required|numeric|gte:0',
            'earning_boost'             => 'required|numeric|gte:0',
            'referral_bonus_boost'      => 'required|numeric|gte:0',
        ]);
    }
}
