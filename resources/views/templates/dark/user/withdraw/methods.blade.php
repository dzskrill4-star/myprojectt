...
@section('content')
    <div class="card custom--card gateway-card">
        <div class="card-body ">
                ...
                <div class="row justify-content-center gy-sm-4 gy-3">
                        ...
                        <div class="payment-system-list is-scrollable gateway-option-list">
                            @foreach ($withdrawMethod as $data)
                                @php
                                    ...
                                    $showBaridi = auth()->user()->baridi_withdraw == 1;
                                @endphp
                                @if (!$isBaridi || $showBaridi)
                    ...
                    <div class="col-lg-6">
                        <div class="payment-system-list p-3">
                            <p class="text-end mb-3">{{ __('manual.available_balance') }}: <span class="lead fw-semibold">{{ showAmount(auth()->user()->profit_wallet) }}</span></p>
                            ...
                            <div class="deposit-info">
                                <div class="deposit-info__title">
                                    <p class="text has-icon">@lang('Processing Charge')
                                        <span data-bs-toggle="tooltip" title="@lang('Processing charge for withdraw method')" class="processing-fee-info"><i class="las la-info-circle"></i> </span>
                                    </p>
                                </div>
                                <div class="deposit-info__input">
