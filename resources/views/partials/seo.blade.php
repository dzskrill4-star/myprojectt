@if($seo)
    ...
    <meta name="description" content="{{ isset($seoContent) ? $seoContents->description : $seo->description }}">
    <meta name="keywords" content="{{ implode(',',isset($seoContent) ? $seoContents->keywords : $seo->keywords) }}">
    ...
    <meta itemprop="description" content="{{ isset($seoContent) ? $seoContents->description : $seo->description }}">
    <meta itemprop="image" content="{{ $seoImage ?? getImage(getFilePath('seo') .'/'. $seo->image) }}">
    {{--<!-- Facebook Meta Tags -->--}}
    <meta property="og:type" content="website">
    <meta property="og:title" content="{{ isset($seoContent) ? $seoContents->social_title : $seo->social_title }}">
    <meta property="og:description" content="{{ isset($seoContent) ? $seoContents->social_description : $seo->social_description }}">
