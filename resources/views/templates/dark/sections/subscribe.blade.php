                    ...
                    <form class="call-to-action-form" action="#">
                        <div class="subscription-form">
                            <div class="input--group">
                                ...
                                <button class="btn btn--base subscription-button px-4 py-2" type="submit">{{ __($content->data_values->button_text ?? '') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        (function($) {
            $(document).on('submit', '.call-to-action-form', function(e) {
                ...
                if (!email) {
notify('error', `@lang('Email field is required')`);
                } else {
                    $.ajax({
                        headers: {
