    ...
    <div class="contact-form">
        <form action="{{ route('ticket.store') }}" class="disableSubmission" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <button type="button" class="btn btn--base btn--sm addAttachment my-2"> <i class="la la-plus"></i> @lang('Add Attachment') </button>
                    <p class="mb-2"><span class="file-size-note text--muted">@lang('Max 5 files can be uploaded | Maximum upload size is ' . convertToReadableSize(ini_get('upload_max_filesize')) . ' | Allowed File Extensions: .jpg, .jpeg, .png, .pdf, .doc, .docx')</span></p>
                    ...
                    <div class="col-lg-6 col-md-12 removeFileInput">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <button type="button" class="input-group-text btn--danger removeFile"><i class="la la-times"></i></button>
                            </div>
                        </div>
                    </div>
                `)
