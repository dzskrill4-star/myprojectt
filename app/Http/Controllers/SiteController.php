...
class SiteController extends Controller {
    ...
    $reference = request()->ref ?? request()->reference ?? null;
    ...
    public function contact() {
        ...
        $seoContents = $sections->seo_content;
        $seoImage    = $seoImage = $seoContents?->image ? getImage(getFilePath('seo') . '/' . $seoContents?->image, getFileSize('seo')) : null;
    ...
    public function blogDetails($slug) {
        ...
        $latestBlogs = Frontend::activeTemplate()->where('slug', '!=', $slug)->where('data_keys', 'blog.element')->orderBy('id', 'DESC')->take(8)->get();
