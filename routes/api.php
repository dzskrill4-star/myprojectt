        ...
        Route::middleware(['check.status'])->group(function () {
            Route::middleware('registration.complete')->group(function () {
                Route::controller('UserController')->group(function () {
                    ...
                    Route::post('wallet/moving/site-currency/{id}', 'transferToProfitWallet');

                    Route::get('mining-tracks', 'miningTrack');
                ...
                Route::controller('WithdrawController')->prefix('withdraw')->group(function () {
                    ...
                    Route::post('request/confirm', 'withdrawSubmit')->name('confirm');
                    Route::get('history', 'withdrawLog');
                });

                // Payment
                Route::controller('PaymentController')->group(function () {
                    Route::get('deposit/methods', 'methods')->name('payment.method');
