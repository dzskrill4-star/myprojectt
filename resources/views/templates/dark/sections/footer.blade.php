                ...
                <div class="footer-item">
                    ...
                    <ul class="footer-menu">
                        @foreach ($policyPages as $page)
                            <li class="footer-menu__item"><a class="footer-menu__link" href="{{ route('policy.pages', $page->slug) }}">{{ __($page->data_values->title) }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="footer-item">
                    ...
                    <ul class="footer-contact-menu">
                        ...
                        <li class="footer-contact-menu__item">
                            ...
                            <div class="footer-contact-menu__item-content">
                                <p><a href="mailto:{{ $contactCaption->data_values->email_address ?? '' }}">{{ $contactCaption->data_values->email_address ?? '' }}</a>
                                </p>
                            </div>
                        </li>
                        <li class="footer-contact-menu__item">
