...
class WithdrawController extends Controller
{
    public function withdrawMethod()
    {
        ...
        return responseSuccess('withdraw_methods', $notify, [
            ...
            'profit_wallet_balance' => auth()->user()->profit_wallet,
    ...
    public function withdrawStore(Request $request)
    {
        ...
        $method = WithdrawMethod::where('id', $request->method_id)->active()->first();
        if (!$method) {
        ...
        if ($request->amount > $user->profit_wallet) {
            $notify[] = 'Insufficient profit balance for withdrawal';
            return responseError('validation_error', $notify);
        }
    ...
    public function withdrawSubmit(Request $request)
    {
        ...
        if ($withdraw->amount > $user->profit_wallet) {
            $notify[] = 'Your request amount is larger then your current profit balance';
            return responseError('validation_error', $notify);
        }
