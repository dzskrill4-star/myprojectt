                        ...
                        <div class="contact-information-wrapper">
                            ...
                            <div class="contact-information__item">
                                ...
                                <div class="contact-information__content">
                                    ...
                                    <p class="contact-information__desc"><a href="mailto:{{ $content->data_values->email_address ?? '' }}">{{ $content->data_values->email_address ?? '' }}</a>
                                    </p>
                                </div>
                            </div>
                            <div class="contact-information__item">
                                ...
                                <div class="contact-information__content">
                                    ...
                                    <p class="contact-information__desc"><a href="tel:{{ str_replace(' ', '', $contact->data_values->contact_number ?? '') }}">{{ $content->data_values->contact_number ?? '' }}</a>
                                    </p>
                                </div>
                            </div>
                            @if (count($socials))
                            ...
                            <div class="row gy-3">
                                <div class="col-12">
                                    <div>
                                        ...
                                        <input class="form--control" name="name" type="text" value="{{ auth()->user() ? auth()->user()->fullname : old('name') }}" placeholder="@lang('Your Name')" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div>
                                        <label class="form-label">@lang('Email')</label>
                                        <input class="form--control" name="email" type="text" value="{{ auth()->user() ? auth()->user()->email : old('email') }}" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div>
